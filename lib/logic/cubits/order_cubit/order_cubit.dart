...
class OrderCubit extends Cubit<OrderState> {
 ...
 // TODO Create _handleUserState funcion
  ...
  // TODO Create _initialize funcion
  ...
  // TODO Create createOrder funcion
  Future<OrderModel?> createOrder({
    ...
    try {
      ...
      List<OrderModel> orders = [order, ...state.orders ];   //* <-- New Lis Created
...
// TODO Create updateOrder funcion
